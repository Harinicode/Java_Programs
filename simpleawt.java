import java.util.*;
import java.awt.*;	//C:\Users\J Harini\OneDrive\Desktop\jprogram
import java.awt.event.*;
class Info2
{
		int rollno;
		String name;
		Info2(int rollno,String name)
		{
			this.rollno=rollno;
			this.name=name;
			...
			Info2()
			{
				...
				display.addActionListener(new ActionListener()
				{
					public void actionPerformed(ActionEvent e)
					{
						...
						ArrayList<Info2> al=new ArrayList<Info2>();
						al.add(new Info2(rollno,name));
						for(Info2 s:al)
						{
